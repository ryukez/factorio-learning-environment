...
class Entity(EntityCore):
    ...
    def __repr__(self) -> str:
        ...
        occupied_points = []
        for i in range(int(self.tile_dimensions.tile_width)):
            for j in range(int(self.tile_dimensions.tile_height)):
                dx = float(i) - (self.tile_dimensions.tile_width - 1) / 2
                dy = float(j) - (self.tile_dimensions.tile_height - 1) / 2
        ...
        repr_dict["occupied_positions"] = occupied_points
        # del repr_dict["neighbours"]

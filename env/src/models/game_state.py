...
class GameState:
    ...
    def from_instance(cls, instance: "FactorioInstance") -> "GameState":
        ...
        entities = instance.namespace._save_entity_state(compress=False, encode=False)
        ...
        if hasattr(instance.namespace, "persistent_vars"):
            serializable_vars = filter_serializable_vars(
                instance.namespace.persistent_vars
            )
    ...
    def to_raw(self) -> str:
        ...
        data = {
            ...
            if hasattr(self.inventory, "__dict__")
            else self.inventory,
